export function SwitchAccountIcon({ width = 16, height = 16, className = '', fill = 'currentColor' }) {
    return (
        <svg 
            viewBox="0 0 20 20" 
            fill={fill} 
            ...
            className={`icon_e634ab32bf icon-service-icon noFocusStyle_b51f6a8a28 ${className}`}
            data-testid="icon" 
            data-vibe="Icon"
        >
            <path 
